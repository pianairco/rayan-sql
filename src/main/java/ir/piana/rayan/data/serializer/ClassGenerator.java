...
import ir.piana.rayan.data.persist.Printed;
...
public class ClassGenerator {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException, InstantiationException {
        ...
        StringBuffer stringBuffer = new StringBuffer("public class TestClass implements ir.piana.rayan.data.persist.Printed{");
